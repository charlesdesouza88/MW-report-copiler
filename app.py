...
GENERATE_RATE_LIMIT = os.environ.get('GENERATE_RATE_LIMIT', '3 per minute')
...
def _migrate_registry_semesters(data):
    ...
    try:
        ...
        logger.warning('Could not load lessons while migrating class registry semesters: %s', exc)
